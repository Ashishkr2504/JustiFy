...
exports.trackCaseByCnr = exports.getCaptchaImage = void 0;
...
const getCaptchaImage = async (req, res) => {
    try {
        ...
        const captchaSrc = await page.$eval("#captcha_image", (img) => img.src);
...
const trackCaseByCnr = async (req, res) => {
...
exports.trackCaseByCnr = trackCaseByCnr;
